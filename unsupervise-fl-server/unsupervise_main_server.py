...
def parse_option():
    ...
    ## model
    parser.add_argument('--dim_weight_unsupervise', type=int, default = 41125184)
...
weight_COLLECTION = np.zeros((opt.num_of_users, opt.dim_weight_unsupervise))
weight_MEAN = np.zeros(opt.dim_weight_unsupervise)
...
def server_update():
	...
	global aggregation_time_record, wait_time_record, server_start_time_record, downlink_time_record
	...
	save_model_path = "./save_server_time_unsupervise_{}nodes/".format(opt.num_of_users)
